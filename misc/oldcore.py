...
def create_model_architecture(input_size):
    ...
    classifier.add(Dense(1, input_shape =(input_size,)))
    ...
    # create output layer
    #output_layer = layers.Dense(3, activation="sigmoid")(input_layer)
...
def create_cnn():
    ...
    model.compile(optimizer=optimizers.Adam(), loss='categorical_cossentrophy')
...
accuracySNN = train_model(classifier, xtrain_count, train_y, xvalid_count, is_neural_net=True)
print ("NN, [Ngram Level TF IDF] Word Vectors: ",  accuracySNN, flush=True)
...
#accuracyCNN = train_model(classifier, xtrain_count, train_y, xvalid_count, is_neural_net=True)
#print ("CNN, [Word Embeddings]: ",  accuracyCNN, flush=True)

p.progress(37, pbartotal)
classifier = create_rnn_lstm()
accuracyRNN = train_model(classifier, xtrain_count, train_y, xvalid_count, is_neural_net=True)
print ("RNN-LSTM, [Word Embedding]s: ",  accuracyRNN, flush=True)

p.progress(38, pbartotal)
classifier = create_rnn_gru()
accuracyRNNGRU = train_model(classifier,  xtrain_count, train_y,  xvalid_count, is_neural_net=True)
print ("RNN-GRU, [Word Embeddings]: ",  accuracyRNNGRU, flush=True)

p.progress(39, pbartotal)
classifier = create_bidirectional_rnn()
accuracyRNNBI = train_model(classifier, xtrain_count, train_y, xvalid_count, is_neural_net=True)
print ("RNN-Bidirectional, [Word Embeddings]: ",  accuracyRNNBI, flush=True)

p.progress(40, pbartotal)
classifier = create_rcnn()
accuracyRCNN = train_model(classifier, xtrain_count, train_y, xvalid_count, is_neural_net=True)
